...
__all__ = ['generate_linear_model_html', 'generate_logistic_model_html', 'plot_2d_regression',
...
# Cell
def plot_2d_regression(model, X: pd.DataFrame, y: Union[np.array, pd.Series]):
