...
# %% auto 0
__all__ = ['calculate_metrics_by_thresh_binary', 'plot_pr_curve', 'calculate_metrics_by_thresh_multi', 'coverage',
...
@delegates(metrics.precision_recall_curve)
def plot_pr_curve(
    y_true: np.array,
    y_prob: np.array,
